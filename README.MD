...
1) Run `./gradlew :krawler:publishToMavenLocal`
2) Open `~/.m2/repository/solutions/dreamforge/krawler/"}`
...
4) Add the secrets to `local.properties`:
   ...
   ```
5) Run `./gradlew :krawler:publishAllPublicationsToSonatypeRepository`
